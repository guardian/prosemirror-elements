    ...
    describe("Rich text field", () => {
      rteFields.forEach((field) => {
        ...
        it("should serialise content as HTML within the appropriate nodes in the document", () => {
          ...
          assertDocHtml(
            `<imageelement type="imageElement" has-errors="false"><div class="ProsemirrorElement__imageElement-altText"><p>Alt text</p></div><div class="ProsemirrorElement__imageElement-caption"><p>Caption text</p></div><element-imageelement-mainimage class="ProsemirrorElement__imageElement-mainImage" fields="{&quot;src&quot;:&quot;&quot;}"></element-imageelement-mainimage><element-imageelement-options class="ProsemirrorElement__imageElement-options" fields="[{&quot;text&quot;:&quot;Option 1&quot;,&quot;value&quot;:&quot;opt1&quot;,&quot;isSelected&quot;:true},{&quot;text&quot;:&quot;Option 2&quot;,&quot;value&quot;:&quot;opt2&quot;,&quot;isSelected&quot;:false},{&quot;text&quot;:&quot;Option 3&quot;,&quot;value&quot;:&quot;opt3&quot;,&quot;isSelected&quot;:false}]"></element-imageelement-options><div class="ProsemirrorElement__imageElement-src"></div><element-imageelement-usesrc class="ProsemirrorElement__imageElement-useSrc" fields="{&quot;value&quot;:false}"></element-imageelement-usesrc></imageelement><p>First paragraph</p><p>Second paragraph</p>`
          );
        });
      });
    });
